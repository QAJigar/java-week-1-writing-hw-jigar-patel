...
public class Programme_1_BioData {
    public static void main(String[] args) {
        ...
        System.out.println("Languages Known   : Englesh, Spenish and German");
        System.out.println("Qualification     : Software Trster");
        System.out.println("Experiance        : Agile Tester with 5 years of experience");
